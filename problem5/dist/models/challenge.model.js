...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.ENUM, values: ['easy', 'medium', 'hard'], defaultValue: 'medium' }),
    __metadata("design:type", String)
...
__decorate([
    ...
    __metadata("design:type", String)
], Challenge.prototype, "sampleSolution", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.TEXT),
    __metadata("design:type", String)
...
exports.Challenge = Challenge = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'challenges' })
], Challenge);
